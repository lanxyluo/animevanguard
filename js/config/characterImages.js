...
export function getCharacterImage(characterId) {
  ...
  if (!imageData) {
    return "https://via.placeholder.com/64x64/95a5a6/ffffff?text=" + characterId.substring(0, 3).toUpperCase();
  }
  
  return imageData.fallback; // Use fallback for now until we have real images
}
